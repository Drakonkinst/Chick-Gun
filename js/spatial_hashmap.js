 ...
 */
const SpatialHashMap = (() => {
    const OVERLAP = 1;
    return class SpatialHashMap {
        /**
         ...
         *                             Generally a good idea for querying static
         *                             objects.
         */
        constructor(cellSize, fillNearby) {
            this.cellSize = cellSize;
            this.map = {};
            this.fillNearby = fillNearby || false;
            this.size = 0;
        }
        ...
        queryDynamic(vector, distance) {
            ...
            //console.log(queriesMade + " queries made");
            return list;
        }
        ...
        removeAtKey(obj, key) {
            ...
            if(list != null) {
                ...
                console.log("Failed to remove at " + key);
            }
        }
